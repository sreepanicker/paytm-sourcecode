...
<%@page session="true" %>
<%@page import="com.couchbase.client.java.document.JsonDocument" %>
<%@page import="com.couchbase.client.java.document.json.JsonObject"%>
<%@page import="com.couchbase.client.java.document.json.JsonArray"%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <%
            if (session.getAttribute("sessionId")==null ){
                response.sendRedirect("/paytmlogin/login.jsp");
            }else{
            ...
            JsonDocument jdoc = (JsonDocument) request.getAttribute("json");
        %>
        <style>
            .container{
                padding: 16px;
    ...
    <body>        
        <div class="container">
            <div class="logoutsec">
                <form name="logout" action="/paytmlogin/controller" method="post">
                    <button type="submit" class="submitbtn">Logout</button>
                    <label class="loggedinuser"> Logged in User :<%=jdoc.content().getString("fullname")%> </label>
            ...
            <div class="changepass" id="passclass">
                <form name="changepassword" action="/paytmlogin/controller" onsubmit="return product()" method="post" >
            ...
            <div class="historydetails">
                ...
                <table><tr><th>Action</th><th>Time</th></tr>
                 <% JsonArray jsonArray = jdoc.content().getArray("activity");
                 for(int i =0; i < jsonArray.size();i++){%>
                    <tr><td><%=((JsonObject)jsonArray.get(i)).getString("action")%></td><td><%=((JsonObject)jsonArray.get(i)).getString("time")%></td></tr>
                 <%}%>
                </table>
            </div>
            <div class="footer">
